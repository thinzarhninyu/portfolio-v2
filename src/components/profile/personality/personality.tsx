        ...
        <div className='px-10'>
            ...
            <div className='flex flex-col sm:flex-row md:flex-row justify-between items-center md:space-y-5 sm:space-y-5 lg:space-x-10'>
                ...
                <div className='text-justify flex-1'>
                    ...
                    <Link
                        href="https://www.16personalities.com/profiles/121a9b151439f"
                        className={`${buttonVariants({ variant: "secondary" })} flex flex-row justify-center items-center px-4 py-2 text-sm font-semibold rounded-lg shadow-md bg-white hover:bg-gray-100 hover:underline focus:ring-black`}
                    >
                        View my personality profile!</Link>
                </div>
            </div>
